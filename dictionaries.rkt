...
# Defines struct 'm' to hold a key-value pair with
struct m:
    let key
    let value
...
class AssociationList[K, V] (DICT):
    ...
    def put(self,key,value):
        self._head=n(m(key,value),self._head) # Creates a new node at the beginning of the list with the given key-value pair
